...
from hexagons.game.driven.adapters.mltraining_data_collector import MLTrainingDataCollector
from hexagons.game.domain.ports.mltraining_data_collector import MLTrainingDataCollectorPort
...
@lru_cache()
def get_mltraining_data_collector() -> MLTrainingDataCollectorPort:
    ...
    return MLTrainingDataCollector(
