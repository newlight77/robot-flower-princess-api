...
def test_autoplay_greedy_and_optimal_both_callable():
    ...
    repo.save_history("greedy_game", GameHistory(game_id="greedy_game"))
    repo.save_history("optimal_game", GameHistory(game_id="optimal_game"))
...
def test_autoplay_strategy_selection_isolation():
