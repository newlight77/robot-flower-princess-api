...
def test_pick_error_records_failed_action_direction():
    ...
    with patch(
        "robot_flower_princess.domain.use_cases.pick_flower.GameService.pick_flower",
...
def test_drop_error_records_failed_action_direction():
    ...
    with patch(
        "robot_flower_princess.domain.use_cases.drop_flower.GameService.drop_flower",
...
def test_give_error_records_failed_action_direction():
    ...
    with patch(
        "robot_flower_princess.domain.use_cases.give_flowers.GameService.give_flowers",
...
def test_clean_error_records_failed_action_direction():
    ...
    with patch(
        "robot_flower_princess.domain.use_cases.clean_obstacle.GameService.clean_obstacle",
        side_effect=GameException("boom"),
    ):
