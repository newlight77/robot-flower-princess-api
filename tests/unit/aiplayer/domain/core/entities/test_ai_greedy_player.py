...
class TestAIGreedyPlayer:
    ...
    def test_large_board_navigation(self):
        ...
        robot = Robot(position=Position(0, 0), orientation=Direction.EAST)
        board = Game(rows=12, cols=12, robot=robot, princess_position=Position(11, 11))
    ...
    def test_robot_starts_next_to_princess(self):
        ...
        robot = Robot(position=Position(2, 2), orientation=Direction.EAST)
        board = Game(rows=5, cols=5, robot=robot, princess_position=Position(2, 3))
    ...
    def test_rectangular_board_wider_than_tall(self):
        ...
        robot = Robot(position=Position(0, 0), orientation=Direction.EAST)
        board = Game(rows=5, cols=10, robot=robot, princess_position=Position(4, 9))
    ...
    def test_single_flower_at_max_distance(self):
        ...
        robot = Robot(position=Position(0, 0), orientation=Direction.EAST)
        board = Game(rows=15, cols=15, robot=robot, princess_position=Position(7, 7))
    ...
    def test_ultra_large_board(self):
        ...
        robot = Robot(position=Position(0, 0), orientation=Direction.EAST)
        board = Game(rows=20, cols=20, robot=robot, princess_position=Position(19, 19))
    ...
    def test_flower_at_each_orientation_from_center(self):
        ...
        board = Game(rows=9, cols=9, robot=robot, princess_position=Position(4, 4))
